...
Tuesday.prototype = {
        ...
        setWeek:        function(startDateString){
        ...
        buildStructure: function(){
                            ...
                            this.container.append(this.week);
														this.container.append(this.day);
...
var startDate0 = listData.startDate.split(" ")[0];
var startDateArr = startDate0.split('-');
var startDateStringg = startDateArr[0]+'-'+startDateArr[1]+'-'+startDateArr[2];
