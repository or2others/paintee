...
function Payment(){
    ...
    this.payByPaypal  =$("<div>").addClass("payby_btn").append("<img class='icon' src='ico/pay_paypal.png'><div class='purchase_btn_text'><div class='purchase_btn_text'><span data-i18n='[html]payment.1'></span></div>")
                        .click(function(){paymentByPaypal()});
    this.payByAndroid =$("<div>").addClass("payby_btn").append("<img class='icon' src='ico/pay_android.png'><div class='purchase_btn_text'><div class='purchase_btn_text'><span data-i18n='[html]payment.2'></span></div>")
                        .click(function(){paymentByAndroid()});
    this.payByiOS     =$("<div>").addClass("payby_btn").append("<img class='icon' src='ico/pay_ios.png'><div class='purchase_btn_text'><div class='purchase_btn_text'><span data-i18n='[html]payment.3'></span></div>")
                        .click(function(){paymentByiOS()});
    this.payByReward  =$("<div>").addClass("payby_btn").append("<img class='icon' src='ico/attach_money.png'><div class='purchase_btn_text'><div class='purchase_btn_text'><span data-i18n='[html]payment.4'></span></div>")
                        .click(function(){paymentByReward()});
    this.payByCode    =$("<div>").addClass("payby_btn").append("<img class='icon' src='ico/pay_promotion.png'><div class='purchase_btn_text'><div class='purchase_btn_text'><span data-i18n='[html]payment.5'></span></div>")
...
//         }else if(checkPaymentPlatform()=="iOS"){
        ...
        exeTranslation('.payment_container', lang);
    },
...
function initPayment(serviceCnt, option){
    ...
    if(option == "tuesday"){
        ...
        $(".payment_btn").click(function(){
                ...
                purchaseController.addPurchase(serviceCnt+1,0);
                showPurchaseSpinner();
        })
        ...
        payment.buildPayment();
        $(".payment_btn").click(function(){
                purchaseController.addPurchase(serviceCnt,0);
                showPurchaseSpinner();
        })
    }
    delete payment;
...
function paymentByiOS(){
  ...
  this.purchaseProvider = 3;
  this.purchaseType = 'IOS';
  $(".payment_box").empty();
  var payment = new Payment();

  payment.setTitle("Payment");
  payment.setBottom("<div class='popup_btn payment_btn'><div class='purchase_btn_text'>Payment </div><img class='icon' src='ico/attach_money.png'></div>");
  payment.buildPayment();
  ...
  showPurchaseSpinner();
   ...
   cordova.exec(function(result){
     ...
     purchaseController.addPurchase(3, 3);
    ...
    //       })
    // .then(() => {
    //     var token = validationData.receipt;
    //     purchaseToken = token;
    //
    //     purchaseController.addPurchase(3, 3);
...
$(".payment_contents ").html("<span data-i18n='[html]purchasePop1.contents1'></span>");

    var payByPaypal  =$("<div>").addClass("payby_btn").append("<img class='icon' src='ico/pay_paypal.png'><div class='purchase_btn_text'><span data-i18n='[html]payment.1'></span></div>")
                        .click(function(){paymentByPaypal()});
    var payByAndroid =$("<div>").addClass("payby_btn").append("<img class='icon' src='ico/pay_android.png'><div class='purchase_btn_text'><span data-i18n='[html]payment.2'></span></div>")
                        .click(function(){paymentByAndroid()});
    var payByiOS     =$("<div>").addClass("payby_btn").append("<img class='icon' src='ico/pay_ios.png'><div class='purchase_btn_text'><span data-i18n='[html]payment.3'></span></div>")
                        .click(function(){paymentByiOS()});
    var payByReward  =$("<div>").addClass("payby_btn").append("<img class='icon' src='ico/attach_money.png'><div class='purchase_btn_text'><span data-i18n='[html]payment.4'></span></div>")
                        .click(function(){paymentByReward()});
    var payByCode    =$("<div>").addClass("payby_btn").append("<img class='icon' src='ico/pay_promotion.png'><div class='purchase_btn_text'><span data-i18n='[html]payment.5'></span></div>")
                        .click(function(){paymentByCode()});
...
PurchaseController.prototype = {
    ...
    AjaxCall.call(apiUrl + "/notify",
                  ...
                  "POST",
                  function(result2){
                  controller.addPurchaseRes(result2);
                  }
                  );
},
